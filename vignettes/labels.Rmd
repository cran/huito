...
You can change any layer dynamically based in a column. In this case, the color of the text condition will change based in the treatments: "blue" for `irrigated` and "red" for `drought`.
